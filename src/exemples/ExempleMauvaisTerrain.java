...
public class ExempleMauvaisTerrain {

	public static void main(String[] args) throws IOException {
		// Définition du jeu
		Jeu jeu = new Jeu("tests.EnigmeBloque");
		...
		mv6.setPosSortie(new Position(3, 5));

		Mobile mv7 = mb.clone();
		mv7.setNom("mb7");
		mv7.setPosEntree(new Position(1, 1));
		mv7.setPosSortie(new Position(3, 5));

		Mobile mv8 = mb.clone();
		mv8.setNom("mb8");
		mv8.setPosEntree(new Position(1, 1));
		mv8.setPosSortie(new Position(3, 5));
